...
class MyListPicker extends StatelessWidget {
  const MyListPicker({Key key, @required this.title, @required this.fetchStatus, @required this.itemList, this.initalValue, this.onChanged}) : super(key: key);
...
class ListPickerItem {
  ListPickerItem({this.label, this.description, this.value});
